...
#SBATCH --job-name=moe
#SBATCH --output=/mnt/petrelfs/share_data/songmingyang/runs/mixtral_random_split_64gpus_8_2/%x-%j.log
#SBATCH --error=/mnt/petrelfs/share_data/songmingyang/runs/mixtral_random_split_64gpus_8_2/%x-%j.log
...

{
    ...
    model_type="llama"
    comment="llama-moe, random 2/8, sheared llama data portion"
    pretrained_model=/mnt/petrelfs/share_data/songmingyang/models/llama-moe/LLaMA-MoE-v1-3_5B-2_8
    tokenizer_path=/mnt/petrelfs/share_data/songmingyang/models/llama-moe/LLaMA-MoE-v1-3_5B-2_8
